  ...
  return (
    <Card className="max-w-2xl mx-auto border border-slate-200 shadow-xl bg-white/95 backdrop-blur-sm rounded-2xl overflow-hidden">
      <div className="text-center mb-8 pt-8 px-6 bg-slate-50 border-b border-slate-100 pb-8">
        <h2 className="text-3xl font-fredoka font-semibold text-slate-800 mb-3 tracking-wide">
        ...
        {isMinor && (
          <div className="p-6 bg-slate-50 rounded-xl border border-slate-200 space-y-4 animate-in fade-in slide-in-from-top-4 duration-300">
            <h3 className="font-semibold text-slate-800 flex items-center gap-2 text-lg">
              Parental Consent
              <span className="text-[10px] font-bold uppercase tracking-wider bg-slate-200 text-slate-700 px-2 py-1 rounded-full">
                Required
              </span>
            </h3>
            ...
            <div className="flex items-center gap-4 pt-2">
              ...
              <span className="text-xs text-slate-500 font-medium italic">
                Please have a parent or guardian sign this form.
              </span>
            </div>
          </div>
        )}
              ...
              <div className="flex flex-col items-center gap-4 relative z-10">
                ...
                <div className="space-y-3 max-w-lg mx-auto">
                  <p className="font-medium text-slate-700 text-lg">
                    Please record a short video answering the following:
                  </p>
                  ...
                  <ul className="text-sm text-slate-600 text-left space-y-2 bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
                    <li className="flex gap-2">
                      ...
                      <span>Tell us about yourself and why you want to volunteer with Richmond Senior Center.</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="font-semibold">2.</span>
                      <span>What experience do you have working with seniors, or what makes you interested in helping the senior community?</span>
                    </li>
                    <li className="flex gap-2">
                      <span className="font-semibold">3.</span>
                      <span>How much time can you commit to volunteering each week or month?</span>
                    </li>
                  </ul>

                  <p className="text-xs text-slate-500 font-medium uppercase tracking-wide pt-2">
